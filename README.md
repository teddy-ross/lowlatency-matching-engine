...
This project is an evolving **low-latency matching engine** and **market data handler prototype**, written in **C++20**. It is a work in progress, with many features and optimizations to be made. I'm building this to learn more about low-latency programming in C++. The below README is outdated and will be updated in time.
